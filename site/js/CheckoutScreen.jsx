...
const { Button, Input, Select, Checkbox, SectionHeading, Badge } = window.GEPCOFormaciNDesignSystem_bb6094;
...
function useCartItems() {
  ...
  React.useEffect(() => {
    ...
    const h = (e) => setItems((e && e.detail) || window.GEPCO_CART.items());
      ...
      <section style={{ background: "var(--surface-sunken)", padding: "var(--section-y) 0 var(--space-24)" }}>
        <Container style={{ maxWidth: "760px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <Button variant="primary" uppercase iconRight={<span>→</span>} onClick={() => { window.GEPCO_CART && window.GEPCO_CART.clear(); onNav("catalog"); }}>Ver más formaciones</Button>
